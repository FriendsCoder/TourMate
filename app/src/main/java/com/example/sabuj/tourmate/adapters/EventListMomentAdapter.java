...
public class EventListMomentAdapter extends RecyclerView.Adapter<EventListMomentAdapter.EventListViewHolder> {
    private Context context;
    private ArrayList<String> eventListExpense;
    FragmentTransaction transaction;

    public EventListMomentAdapter(Context context, ArrayList<String> eventListExpense, FragmentTransaction transaction) {
