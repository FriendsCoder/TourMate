...
import com.example.sabuj.tourmate.adapters.EventListMomentAdapter;
...
public class MomentEventListFragment extends Fragment {
    RecyclerView recyclerView;
    EventListMomentAdapter eventListMomentAdapter;
        ...
        refUserEvent.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (eventList != null && eventList.size() > 0) {
                    ...
                    eventListMomentAdapter = new EventListMomentAdapter(getContext(), eventList,transaction);
